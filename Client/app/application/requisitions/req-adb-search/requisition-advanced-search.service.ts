...
@Injectable()
export class RequisitionAdvancedSearchService {
  ...
  // get Requisition Verticals List

  getVerticalsListAsync(): Observable<any> {
    let url = this.apiurl + "api/Requisition/GetVerticalNameListAsync";
    let options = this.setHttpOptions(RequestMethod.Get, url);
    console.log('options')
    return this.http.get(url, options);
  }
  ...
  // get the SubtowerDetails

  gettheSubTower(apiparam): Observable<any> {
  ...
  // get All Qalification
  getAlltheQualification(): Observable<any> {
  ...
  getSalesRep(apiparam, clientid?, name?): Observable<any> {
  ...
  gettheVMODetails(apiparam, clientid?, name?): Observable<any> {
  ...
  // MS project Details
  getMSProjectDetails(apiparam, clientid?, name?): Observable<any> {
    let url = this.apiurl + "api/Master/GetAllMSProjectNamesAsync";
    let params = {
      "msprojectname": apiparam
    };
    let options = this.setHttpOptions(RequestMethod.Get, url);
    options.params = params;
  ...
  private extractDataitss(res) {
    let body = JSON.parse(res._body).response;
    return body.relatedprojectnames || {};
  }
  ...
  getAllSearchResults(params): Observable<any> {
    let url = this.apiurl + "api/Requisition/AdvancedRequisitionSearch2Async";
  ...
  getDeliveryMgr(text: string): Observable<any> {
    let url = this.apiurl + "api/Master/GetDeliveryManagerListAsync";
    let params = {
      userid: text,
    };
    let options = this.setHttpOptions(RequestMethod.Get, url);
    ...
    // DElivery Model - onshore, offshore, near shore
  ...
  trackActivityPageOpened() {
    return this.dataservice.postPageTracker(
      ...
      { pagename: "RequisitionAdvancedSearch" }
    );
  }
}
