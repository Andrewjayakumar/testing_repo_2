...
@Injectable()
export class RemoveSubmissionService {
  ...
  postRemoveSubmission(candidateId, requisitionId, requestBody): Observable<any> {
    let url = this.apiurl + "api/Candidate/CreateCandidateSubmissionCancelAsync";
    let params = {
