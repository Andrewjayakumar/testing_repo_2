...
@Injectable()
export class VendorAttestationService {
  ...
  getSubtierDetails(candidateId, requisitionId): Observable<any> {
    let url = this.apiurl + "api/Candidate/GetSubtierDetailsByIdAsync";
    let params = {
  ...
  postVendorBypassRequest(candidateId, requisitionId, bypassReason, requestBody): Observable<any> {
    let url = this.apiurl + "api/Candidate/CreateBypassVendorAttestationAsync";
    let params = {
      "candidateid": candidateId,
      "requisitionid": requisitionId,
  ...
  postCreateVendorAttestaton(candidateId, requisitionId, requestBody): Observable<any> {
    let url = this.apiurl + "api/Candidate/CreateVendorAttestationAsync";
    let params = {
      "candidateid": candidateId,
      "requisitionid": requisitionId,
    }
