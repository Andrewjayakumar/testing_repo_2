...
export class TranslateLanguageLoader implements TranslateLoader {
    ...
    public getTranslation(lang: string): any {
        ...
        switch (lang) {
            case "en":
                return Observable.of(require("../../../../wwwroot/assets/locale/en.json"));
            case "fr":
                return Observable.of(require("../../../../wwwroot/assets/locale/fr.json"));
            case "de":
                return Observable.of(require("../../../../wwwroot/assets/locale/de.json"));
            case "ar":
                return Observable.of(require("../../../../wwwroot/assets/locale/ar.json"));
            case "ko":
                return Observable.of(require("../../../../wwwroot/assets/locale/ko.json"));
            case "pt":
                return Observable.of(require("../../../../wwwroot/assets/locale/pt.json"));
            default:
        }
    }
}
